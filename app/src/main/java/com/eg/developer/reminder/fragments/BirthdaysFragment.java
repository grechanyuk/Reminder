...
public class BirthdaysFragment extends AbstractTabFragment {
    ...
    public static BirthdaysFragment getInstance(Context context) {
        ...
        fragment.setTitle(context.getString(R.string.txtTabBirthday));
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView rv = view.findViewById(R.id.recyclerViewBirthday); //Сюда будут подгружаться задачи
    ...
    private List<RemindDTO> localData() { //Имитация сервера
        ...
        Cursor cursor = sqLiteDatabase.query(DBHelper.TABLE_REMINDERS, null, "category_id=" + Constants.BIRTHDAY_CATEGORY_ID, null, null, null, null);
        ...
        if (cursor.moveToFirst()) {
            ...
            TextView textView = view.findViewById(R.id.noDataBirthday);
            textView.setText(R.string.txtNoDataBirthday);
