...
public class ToDoFragment extends AbstractTabFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView rv = view.findViewById(R.id.recyclerViewToDo); //Сюда будут подгружаться задачи
    ...
    private List<RemindDTO> localData() { //Имитация сервера
        ...
        Cursor cursor = sqLiteDatabase.query(DBHelper.TABLE_REMINDERS, null, "category_id=" + Constants.TODO_CATEGORY_ID, null, null, null, null);
        ...
        if (cursor.moveToFirst()) {
            ...
            TextView textView = view.findViewById(R.id.noDataToDo);
            textView.setText(R.string.txtNoDataToDo);
